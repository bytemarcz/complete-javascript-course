...
*/
// conditional operator using ? with a condition . Also called the ternary operator
// not thought of a replacement as if else when we need bigger blocks of code
// perfect when we need quick decisions 
const age = 23;
